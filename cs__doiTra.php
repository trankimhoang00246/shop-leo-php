...
<body>
    ...
    <div class="m_container">
        ...
        <ul>
            <li>
                Hàng hóa bị biến dạng, hỏng hóc do quá trình vận chuyển theo chính sách mua hàng của LEO SPORT Tại thời 
                điểm nhận hàng, quý khách hàng vui lòng kiểm tra sản phẩm và yêu cầu trả lại nếu phát hiện lỗi hoặc không đúng sản 
                phẩm đặt hàng.
            </li>
            <li>
                Sản phẩm bị hỏng hóc, biến dạng do lỗi sản xuất và chưa qua sử dụng.
            </li>
            <li>
                Cam kết đổi trả được quy định riêng đối với từng sản phẩm cụ thể.
            </li>
        </ul>
