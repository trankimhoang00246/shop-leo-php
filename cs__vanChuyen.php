...
<body>
    ...
    <div class="m_container">
        ...
        <hr>
        <br>
        <h2>Quy trình giao nhận vận chuyển : </h2>
        <ul>
            <li>
                LEO SPORT thực hiện giao hàng trên toàn quốc theo bảng phí vận chuyển. Khi quý khách hàng đặt hàng thành công qua 
                website, LEO SPORT sẽ tiến hành giao hàng theo yêu cầu của quý khách hàng.
            </li>
            <li>
                Giao hàng tận nơi dự kiến 2 - 3 ngày làm việc tại TP. Hồ Chí Minh. Từ 3 - 5 ngày cho các tỉnh thành khác trên cả nước.
            </li>
            <li>
                Trong trường hợp đơn đặt hàng phát sinh chậm trễ trong việc giao hàng hoăc cung ứng dịch vụ, LEO SPORT sẽ liên hệ 
                trực tiếp khách hàng để nắm thông tin và xử lý.
            </li>
            <li>
                LEO SPORT liên kết với đơn vị vận chuyển phù hợp nhằm cung cấp cho gian hàng dịch vụ vận chuyển, giao hàng thu tiền 
                tin cậy và hiệu quả nhất.
            </li>
            <li>
                Các đơn hàng vận chuyển mà gian hàng xác nhận vận chuyển qua hệ thống của LEO SPORT sẽ được chuyển tới hãng vận 
                chuyển để xử lý, lấy hàng, giao hàng:
            </li>
            <li>
                Giao hàng toàn quốc, nhận hàng, kiểm hàng mới thanh toán.
            </li>
        </ul>
    </div>
    <div class="footer">
