...
<body>
    ...
    <div class="m_container">
        ...
        <br>
        <p>
            Cam kết hàng chuẩn như mô tả, hình ảnh, video.
        </p>
        <p> 
            Tất cả sản phẩm mang thương hiệu SPORT SHOP : được phân phối chính thức tại thị trường Việt Nam 
            sẽ được bảo hành theo những quy định sau:
        </p>
        <h2>1. Phạm vi bảo hành</h2>
        <h3>1.1. Sản phẩm và thời hạn bảo hành</h3>
        <p>
            Thời hạn bảo hành sản phẩm được xác nhận dựa vào phiếu bảo hành đi kèm theo từng sản phẩm của LEO SPORT và hóa đơn mua 
            hàng nhưng không được vượt quá thời hạn bảo hành kể từ ngày sản xuất.  Trong trường hợp Khách hàng mất phiếu bảo hành 
            và hóa đơn mua hàng, thời hạn bảo hành kể từ ngày sản xuất sẽ được áp dụng.
        </p>
        <p>
            Thời gian bảo hành: Xem thông tin chi tiết sản phẩm trên website hoặc phiếu bảo hành đi kèm sản phẩm.
        </p>
        <h3>1.2. Điều kiện bảo hành hợp lệ</h3>
        <p>
        ...
        <ul>
            ...
            <li>
                Hư hỏng do chất lượng sản phẩm hay lỗi kỹ thuật trong quá trình sản xuất.
            </li>
            <li>
        ...
        <h3>1.3. Trường hợp từ chối bảo hành</h3>
        <p>
        ...
        <h2>2. Thời gian nhận bảo hành</h2>
        ...
        <h2>3. Địa điểm bảo hành</h2>
        <p>
            Địa chỉ các Trung tâm Bảo hành trên toàn quốc của LEO SPORT được in trên phiếu bảo hành kèm theo sản phẩm hoặc trên website: https://leosport.com
        </p>
        <h3>Lưu ý:</h3>
        <p>
            Trung tâm Bảo hành của SPORT SHOP đều có phiếu tiếp nhận bảo hành khi tiếp nhận sản phẩm bảo hành của Khách hàng (bao gồm 
            thông tin Khách hàng và sản phẩm, thông tin tình trạng sản phẩm, thời gian hoàn tất bảo hành...).
        </p>
        <p>
            Vui lòng liên hệ lại trực tiếp với LEO SPORT theo số tổng đài chăm sóc Khách hàng 19008098 để được hỗ trợ.
        </p>  
        <p>Trân trọng !</p>    
    </div>
    <div class="footer">
