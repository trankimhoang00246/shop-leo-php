        ...
        <div class="main-product">
            <div class="l__main-product">
                <div class="category">
                    <h>Danh mục</h>
                    <a href="">
                        <div>Găng tay cao su</div>
                    </a>
                    <a href="">
                        <div>Găng tay siêu dính</div>
                    </a><a href="">
                        <div>Găng tay dẻo</div>
                    </a><a href="">
                        <div>Găng tay linh hoạt</div>
                    </a>
                </div>
                ...
                <div class="list-product">
                    <div class="row-4-product">
                            ...
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/gangtay/0019141_gang-tay-thu-mon-zocker-gloves-edwin-denxanh-bien.webp">
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/gangtay/20190916_Z2JOrlhh2zOIPD65HYhj5lZf.jpg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/gangtay/43dd725dae72a2e2a09ebc03cdc1bfaf.jpeg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product" src="./assets/img/gangtay/download.jpeg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                    ...
                    <div class="row-4-product">
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product" src="./assets/img/gangtay/FJ5983.jpg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/gangtay/gang-tay-thu-mon-cau-lac-bo-manchester-united-2.webp">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/gangtay/gang-tay-thu-mon-cho-tre-nho-nhung-loi-ich-to.jpg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/gangtay/gang-tay-thu-mon-zocker-Spencer-trang_9840_HasThumb.webp">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
