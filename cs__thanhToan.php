...
<body>
    ...
    <div class="m_container">
        ...
        <h3>Cách 2: Thanh toán qua ngân hàng trực tuyến (Chuyển khoản):</h3>
        <ul>
            <li>Bước 1: Người mua tìm hiểu thông tin về sản phẩm, dịch vụ được đăng tin.</li>
            <li>Bước 2: Người mua điền đầy đủ các thông tin theo hướng dẫn mua hàng</li>
            <li>
                Bước 3: Tại phần “Phương thức thanh toán”, người mua lựa chọn hình thức “Ngân hàng trực tuyến 
                (Chuyển khoản)” và thực hiện theo hướng dẫn</li>
            <li>Bước 4: Người mua thực hiện tiếp các bước trong quy trình đặt hàng</li>
            <li>Bước 5: Người bán chuyển hàng.</li>
            <li>Bước 6: Người mua kiểm tra và nhận hàng.</li>
        </ul>
        <h2>II. Đảm bảo an toàn giao dịch</h2>
        <p>
            LEO SPORT: đã sử dụng các dịch vụ để bảo vệ thông tin về nội dung mà người bán đăng  sản phẩm trên website. 
            Để đảm bảo các giao dịch được tiến hành thành công, hạn chế tối đa rủi ro có thể phát sinh.
        </p>
        <p>
            Người mua nên cung cấp thông tin đầy đủ (tên, địa chỉ, số điện thoại, email) khi tham gia mua hàng của LEO SPORT 
            để có thể liên hệ nhanh lại với LEO SPORT trong trường hợp xảy ra lỗi.
        </p>
        <p>
        ...
        <p>
            ...
            thông tin thẻ. SPORT SHOP không lưu trữ thông tin thẻ của người mua sau khi thanh toán, mà thông qua hệ thống của 
            ngân hàng liên kết. Nên tuyệt đối bảo mật thông tin thẻ cho khách hàng.
        </p>
        <p>
            Trong trường lỗi xảy ra trong quá trình thanh toán trực tuyến, LEO SPORT sẽ là đơn vị giải quyết cho khách hàng 
            trong vòng 1 ngày làm việc từ khi tiếp nhận thông tin từ người thực hiện giao dịch.
        </p>
    </div>
    <div class="footer">
