            ...
            <div class="l__main-product">
                <div class="category">
                    ...
                    <a href="">
                        ...
                        <div>Bóng sân phủi</div>
                    </a><a href="">
                        <div>Bóng châu âu</div>
                    </a>
                </div>
                ...
                <div class="list-product">
                    <div class="row-4-product">
                            ...
                            <div class="prom-product">
                                <a href="./detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/ball/1631286291-1375235712-qu-bong-a-vbe-201-snake-blue.jpg">
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="./detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/ball/20220524_icodKwxxC7nDQoRsV9pYAX1v.jpg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="./detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/ball/qua-bong-da-zocker-empire-2_2785_HasThumb.jpg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="./detail_product.php">
                                    <img class="img-product" src="./assets/img/ball/download.jpeg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                    ...
                    <div class="row-4-product">
                        <div class="column">
                            <div class="prom-product">
                                <a href="./detail_product.php">
                                    <img class="img-product" src="./assets/img/ball/p1988891.avif">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="./detail_product.php">
                                    <img class="img-product" src="./assets/img/ball/p2154017.avif">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="./detail_product.php">
                                    <img class="img-product" src="./assets/img/ball/p2154031.avif">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="./detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/ball/qua-bong-da-futsal-gerustar-galaxy-h3_8450c27173a8498ea39dd0307dd570f4_1024x1024.jpg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                    ...
                    <div class="row-4-product">
                        <div class="column">
                            <div class="prom-product">
                                <a href="./detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/ball/qua-bong-da-vbe-paris-red_1639038739.jpg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="./detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/ball/QUA_BONG_DJA_OCEAUNZ_PRO_trang_HT9011_01_standard.avif">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
