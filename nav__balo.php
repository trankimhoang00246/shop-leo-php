...
<head>
    ...
    <link href="./assets/css/list-product.css" rel="stylesheet" />
    <link rel="stylesheet" href="./assets/css/shoes.css">
    <title>Giày bóng đá</title>
...
<body>
    ...
    <div class="container">
        <div class="main-product">
            <div class="l__main-product">
                <div class="category">
                    <h>Danh mục</h>
                    <a href="">
                        <div>Balo nhỏ gọn</div>
                    </a>
                    <a href="">
                        <div>Balo lớn</div>
                    </a><a href="">
                        <div>Balo nhiều ngăn</div>
                    </a>
                </div>


                <div class="size-shoes">
                    <div class="prod-size">
                        <h>Kích thước</h>
                        <div class="l__prod-type size">
                            <button>36</button>
                            <button>37</button>
                            <button>38</button>
                            <button>39</button>
                    ...
                    <div class="prod-color">
                        <h>Màu sắc</h>
                        <div class="l__prod-type">
                            <button style="background-color: yellow;">Vàng</button>
                            <button style="background-color: blue;">Xanh</button>
                            <button style="background-color: red;">Đỏ</button>
                            <button style="background-color: green;">Xanh lá</button>
                            <button style="background-color: gray;">Xám</button>
                            <button style="background-color: brown;">Nâu</button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row-voucher">
                            <a href="">
                                ...
                                <div class="text-voucher">
                                    Giảm 20k ship cho đơn hàng từ 280k
                                </div>
                            </a>
                            <a href="#" style="text-decoration: underline;">Điều kiện</a>
                        </div>
                        <div class="row-voucher">
                            <a href="">
                                <div class="title-voucher">
            ...
            <div class="m__main-product">
                <div class="list-product">
                    <div class="row-4-product">
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product" src="./assets/img/balo/4-1.jpg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product" src="./assets/img/balo/unnamed.jpg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                            ...
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/balo/Balo-bong-da-egan-2-vnisports-6.jpg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product" src="./assets/img/balo/balo-bulbal-compact-1024x1024.jpg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                    ...
                    <div class="row-4-product">
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product" src="./assets/img/balo/bl02-den2.webp">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/balo/do-2-c0e6303b-4055-4ffe-965d-7507f3698906.webp">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product" src="./assets/img/balo/images (1).jpeg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product" src="./assets/img/balo/images.jpeg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                    ...
                    <div class="row-4-product">
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/balo/Phuocthinhcorp-may-balo-the-thao.jpg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/balo/tui-rut-the-thao-da-bong_007-600x600.jpg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
                        ...
                        <div class="column">
                            <div class="prom-product">
                                <a href="/detail_product.php">
                                    <img class="img-product"
                                        src="./assets/img/balo/Tui-xach-dung-dung-balo-giay-bong-da-do-the-thao-gia-re-nike-moi-nhat-cuc-dep-nhieu-mau-xanh-than.jpg">
                                    <img class="see-more" src="./assets/img/icon-kinh-lup.jpg">
                                    <div class="inf-product">
                                        <div class="name-brand">Leo</div>
                                        <div class="name-product">Giày Kamito Velocidad legend</div>
